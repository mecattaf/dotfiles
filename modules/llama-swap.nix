...
in
{
  ...
  systemd.services.llama-swap = {
    ...
    serviceConfig = {
      ...
      # /var/lib/local-models (optionally borrowed from the NAS Library by an
      # explicit operator transaction — visible read-only through the strict
      # sandbox). Startup never waits for weights; runtime downloads are
      # forbidden by modules/local-models.nix.
