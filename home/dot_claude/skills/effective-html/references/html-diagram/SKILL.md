...
<!-- Vendored from plannotator effective-html plugin. Shared example corpus at ../html-effectiveness/; local example at references/architecture-example.html. -->

Review the SVG diagrams used throughout `../html-effectiveness/`.
