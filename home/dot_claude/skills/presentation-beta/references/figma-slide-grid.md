<!-- Provenance: figma-plugin-jun2026 (figma-use-slides skill), original filename references/slide-grid.md. Copied verbatim. NOTE: this file documents the Figma SlideNode 2D grid API, not visual grid/layout design — retained per ruling but see report. -->
