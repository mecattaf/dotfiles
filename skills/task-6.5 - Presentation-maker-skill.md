---
id: TASK-6.5
title: Presentation maker skill
status: To Do
assignee: []
...
Claude skill for generating presentations. Ref: pre-sync/slides-skill/.
<!-- SECTION:DESCRIPTION:END -->

## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 Skill generates presentation files
<!-- AC:END -->

---

find below the z.ai slides prompt:
