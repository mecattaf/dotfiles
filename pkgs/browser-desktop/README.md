...
> FARA was retired on 2026-09-16 and brought back on 2026-09-19 (Tom: "FARA 9b
> should BE BROUGHT BACK"). Only the 9B returns; the 4B and 27B stay out, so
> the multi-size selection described below is 9B-only in practice until a
> second size is catalogued again. The model unit is operator-started and never
> resident. See `docs/local-ai/fara-restore-2026-09-19.md`.
