...
func (_d *InvitationStateDelete) Where(ps ...predicate.InvitationState) *InvitationStateDelete {
...
func (_d *InvitationStateDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(invitationstate.Table, sqlgraph.NewFieldSpec(invitationstate.FieldID, field.TypeInt))
...
type InvitationStateDeleteOne struct {
	_d *InvitationStateDelete
}

// Where appends a list predicates to the InvitationStateDelete builder.
func (_d *InvitationStateDeleteOne) Where(ps ...predicate.InvitationState) *InvitationStateDeleteOne {
	_d._d.mutation.Where(ps...)
	return _d
}

// Exec executes the deletion query.
func (_d *InvitationStateDeleteOne) Exec(ctx context.Context) error {
	n, err := _d._d.Exec(ctx)
	switch {
	case err != nil:
		return err
	case n == 0:
		return &NotFoundError{invitationstate.Label}
	default:
		return nil
	}
}
