...
systemd-run --user --quiet --collect --unit="mykonos-projector-$$" -- niri msg action spawn -- env "HERDR_INITIAL_PANE=$1" kitty --class herdr-projector --title 'Tom — speech' -e "$HOME/.local/bin/herdr-projector"
