...
#
# Connector name VERIFIED against the live box (2026-07-05, over TB ssh) and
# RE-VERIFIED on NixOS at the 2026-08-21 reintegration: /sys/class/drm/ shows
# card1-DP-1 … DP-8 + HDMI-A-1, so DP-1 exists and one force-enabled connector is
